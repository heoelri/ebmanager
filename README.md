...
- Letzte erfolgreiche Anmeldung jedes Benutzers in der Benutzerverwaltung
...
Pull Requests mit Änderungen unter `public/**` starten zusätzlich den Workflow **UI-Screenshots**. Er rendert Anmeldung, Einsatzübersicht und „Mitglieder & Fahrzeuge“ mit dem lokalen Demo-System und stellt die PNG-Dateien als Workflow-Artefakt bereit. Bei Branches dieses Repositorys aktualisiert der Workflow außerdem einen PR-Kommentar mit einem Link zum Artefakt; Fork-PRs erhalten wegen der eingeschränkten Schreibrechte ausschließlich das Artefakt.
