...
- Änderungen unter `public/**` oder am Screenshot-Test erzeugen mit dem lokalen Demo-Profil und einer gepinnten Playwright-Version 16 UI-Screenshots aller rollenabhängigen Hauptansichten als Workflow-Artefakt. Ein separater `workflow_run` auf dem Standardbranch bettet sie nur für PR-Branches dieses Repositorys in einen aktualisierten Kommentar ein; verwende dafür niemals `pull_request_target` oder einen persönlichen Zugriffstoken im PR-Workflow.
