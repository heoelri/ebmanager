...
case "$invite_status" in
  201)
    ...
    INVITE_EXPIRY="$invite_expiry" php -r '$seconds=(new DateTimeImmutable(getenv("INVITE_EXPIRY"),new DateTimeZone("UTC")))->getTimestamp()-time(); assert($seconds>=604790 && $seconds<=604800);'
